...
<body>
    ...
    <main class="valign-wrapper paleta_fondotext">
        ...
        <div class="row">
            ...
            <h1 class="paleta_fondotitulo z-depth-1">Registro de Citas de Vacunación</h1><br>

            <!--Mensaje para darle los datos del usuario que va a registrar una cita-->
            <h4>
                Hola <b><?php echo "$infAdm[1]";?></b> a continuación se muestran todas tus citas de vacunación y puedes agregar más citas de vacunación para el usuario <b><?php echo "$infAdm[0]";?></b>.
            </h4><br><br>

            <!--Titulo del formulario-->
            <h4><b>Citas de Vacunación del Día:</b></h4>
...
<!------------------------------------Aqui esta el arreglo de tus datos-------------------------------------->
            <div class="datos_usuario" style="margin-top: 50px; margin-bottom: 50px;">
                ...
                <thead class="pink lighten-3">
                    ...
                    <th><i class="fas fa-cog"></i>  Tipo de Vacuna</th><th><i class="fas fa-times"></i>  Eliminar Cita de Vacunación</th></tr>
                </thead>
                <tbody>
