...
<head>
    ...
    <script src="./../js/priv-adm.js"></script>
    ...
    <header>
        ...
        <ul>
            ...
            <li><a href="./citas-adm.php" class="btn-floating tooltipped grey" data-position="left" data-tooltip="Ver Citas Medica"><i class="fas fa-user-md"></i></a></li>
    ...
    <main class="lighten 2 paleta_fondotext">
        ...
        <br><br><h1 class="paleta_fondotitulo z-depth-1">Bienvenido Administrador</h1><br>
        ...
        <div class="imagenes_centradas ">
            ...
            <h4>
            Hola Admistrador se bienvenido a la interfaz del administrador donde podrás observar 3 cosas: las citas medicas de vacunación, citas generales y los usuarios que se han registrado en la plataforma.
        </h4>
            </div>
