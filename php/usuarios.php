...
<head>
    ...
    <header>
        ...
        <ul>
            ...
            <li><a href="./citas-adm.php" class="btn-floating tooltipped grey" data-position="left" data-tooltip="Ver Citas Medica"><i class="fas fa-medkit "></i></a></li>
        </ul>
    ...
    <main class="lighten 2 paleta_fondotext">
        ...
        <h1 class="paleta_fondotitulo z-depth-1">Usuarios Registrados</h1>
        ...
        <div class="imagenes_centradas ">
            ...
            <div class="col s12 m12 l6 ">
                <h4>
                    A continuación, se muestra una tabla con todos los usuarios Registrados en la plataforma
                </h4>
            </div>
        </div>
    ...
    <!------------------------------------Aqui esta el arreglo de tus datos-------------------------------------->
        <div class="datos_usuario" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <thead class="pink lighten-3">
                    <tr><th><i class="fas fa-user"></i>  Usuario</th>
                    <th><i class="fas fa-cog"></i>  Nombre</th>
                    <th><i class="fas fa-envelope"></i>  Correo</th>
                    <th><i class="fas fa-phone"></i>  Numero Telefónico</th></tr>
                </thead>
            <tbody>
