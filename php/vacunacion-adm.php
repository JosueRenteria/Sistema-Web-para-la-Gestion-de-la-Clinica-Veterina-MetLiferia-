...
<head>
    ...
    <script src="./../js/vacunacion-adm.js"></script>
    ...
    <main class="lighten 2 paleta_fondotext">
        ...
        <h1 class="paleta_fondotitulo z-depth-1">Citas de Vacunación Agendadas</h1>
        ...
        <div class="imagenes_centradas ">
            ...
            <div class="col s12 m12 l6 ">
                <h4>
                    A continuación, se muestra una tabla con todas las citas de vacunación agendadas en el Sistema.
                </h4>
            </div>
        </div>
    ...
    <!------------------------------------Aqui esta el arreglo de tus datos-------------------------------------->
        <div class="datos_usuario" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <thead class="pink lighten-3">
                    ...
                    <th><i class="fas fa-thermometer-full"></i>  Tipo de Vacuna</th></tr>
                </thead>
            <tbody>
