<?php
  ...
  $sqlGetAlumnos = "SELECT * FROM alumno WHERE boleta = $boleta";
  ...
  while($filas = mysqli_fetch_array($resGetAlumnos, MYSQLI_BOTH)){
    ...
    <tr>
      ...
      <td>$filas[4]</td>
      <td>
        <i class='fas fa-times icoEliminar iconos-datos' data-boleta='$filas[0]'></i>&nbsp;&nbsp;&nbsp;<i class='fas fa-edit icoEditar iconos-datos' data-boleta='$filas[0]'></i>&nbsp;&nbsp;&nbsp;<i class='fas fa-file-pdf icoPDF iconos-datos' data-boleta='$filas[0]'></i>
      </td>
    </tr>";
  }
?>